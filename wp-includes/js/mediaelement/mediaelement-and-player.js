...
var FlashMediaElementRenderer = {
	create: function create(mediaElement, options, mediaFiles) {
		...
		if (_constants.IS_IE || _constants.IS_EDGE) {
			...
			specialIEContainer.outerHTML = '<object ' + settingsjs';
		} else {
			...
			flash.flashWrapper.innerHTML = '<embed ' + settingsjs';
		}
...
var NativeFlv = {
	...
	load: function load(settings) {
		if (typeof flvjs !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdnjs.cloudflare.com/ajax/libs/flvjs';
...
var FlvNativeRenderer = {
	...
	options: {
		prefix: 'native_flv',
		flv: {
			path: 'https://cdnjs.cloudflare.com/ajax/libs/flvjs',
...
var NativeHls = {
	...
	load: function load(settings) {
		if (typeof Hls !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdnjs.cloudflare.com/ajax/libs/hlsjs';
...
var HlsNativeRenderer = {
	...
	options: {
		prefix: 'native_hls',
		hls: {
			path: 'https://cdnjs.cloudflare.com/ajax/libs/hlsjs',
...
var YouTubeIframeRenderer = {
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		youtube.getPosterUrl = function () {
			...
			return quality && resolutions.indexOf(quality) > -1 && id ? 'https://img.youtube.com/vi/' + id + '/' + quality + 'js';
		};
